function InnerContent({ index = 1, children }) {
    return (
        <div
            ...
            } grid-rows-1 xl:gap-x-[1rem] lg:gap-[1rem] xl:px-[3.75rem] lg:px-[2rem] md:px-[1.4rem]  p-[1.5rem]  bg-white md:rounded-[2.625rem]  rounded-[1.625rem] md:items-center md:justify-start h-full`}
        >
            <div
            ...
            <img
                ...
                className={`md:w-full md:mx-0 ml-auto w-3/12`}
