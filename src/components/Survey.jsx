...
export default function Survey() {
    return (
        ...
        >
            <div className="md:p-[2rem] sm:p-[1rem]  p-[2rem_1rem]">
                <div className="grid lg:grid-cols-[1fr_28.125rem] md:grid-cols-[70%_1fr] sm:grid-cols-[70%_1fr] grid-cols-1 relative">
                    ...
                    <img
                        className="absolute xl:top-[-75%] lg:top-[-50%] md:top-[-75%] md:right-[-4rem]  right-[-2rem] lg:right-0 lg:w-[15rem] md:w-[16rem] w-[9rem] top-[-5rem] right-0"
